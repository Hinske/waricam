...
| Version | **V6.3** — Build 20260316-interior (2026-03-16, 15:20 MEZ) |
...
|-------|-------|---------|---------------|
| **App** | `app.js` | **V6.3** | Wizard, Kontextmenu, Export-Modal, Undo, ToolManager, Click-Routing, Window-Selection, DynamicInput, Print, FSAPI-Save, ProjectManager, CAM-Kontextmenu, Lead-Profiles, Intarsien V2.0, Layer-Visibility→Pipeline |
...
| **Renderer** | `canvas-renderer.js` | **V3.24** | Canvas-Rendering, Hit-Testing, Arc-Leads, DPR-Fix, Grip-Editing, Window-Selection-Rect, Lead-Differenzierung, Trackpad-Navigation, Disc-Füllung (interiorPoint), Intarsien-Overlay, Entry-Pfeil, Hatch-Rendering |
...
| **Pipeline** | `ceracut-pipeline.js` | **V3.4** | Topologie (disc/hole/reference/slit), Kerf-Offset, interiorPoint-basierte Nesting-Erkennung |
| **Drawing Tools** | `drawing-tools.js` | **V2.5** | Tier 1+2 CAD-Tools, AutoCAD-Aliases, Continuous Mode, BreakTool (Snap, CAM-Vererbung) |
| **Drawing Tools Ext** | `drawing-tools-ext.js` | **V1.2** | Ellipse, Spline, Donut, XLine, Overlap Break (OB), Hatch (H) |
...
| **Properties Panel** | `properties-panel.js` | **V1.3** | Kontur-Eigenschaften im Kontextmenu, Piercing, Lead-In, Area-Class, Batch-Editing, Hatch-Schraffur |
...
| **Build-Info** | `build-info.js` | **V6.3** | Versions-Banner, Modul-Versionen, Changelog |
...
│   ├── canvas-renderer.js             ← Canvas Rendering V3.21 (Disc-Fill Fix, Hit-Test)
...
```
CeraCUT/CeraCUT V6.3 - Build 20260316-interior
[BUILD] Modules:
  dxf-parser: V3.10 (20260316-hatchskip)
  geometry: V2.10 (20260316-centroid)
  pipeline: V3.4 (20260316-interior)
  cam-contour: V5.4 (20260316-hatch)
  canvas-renderer: V3.24 (20260316-interior)
  ...
  drawing-tools-ext: V1.2 (20260316-hatch)
