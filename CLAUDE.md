...
│   ├── canvas-renderer.js             ← Canvas Rendering V3.35 (Flächen-Hit, Disc-Fill Fix, Cycle-Selection)
...
```
  ...
  canvas-renderer: V3.35 (20260324-undofix)
