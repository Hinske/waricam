...
| **DXF Writer** | `dxf-writer.js` | **V1.5** | DXF R12 (AC1009) Export, ANSI_1252 Encoding, Kreis-Validierung |
...
│   ├── dxf-writer.js                 ← DXF R12 Export V1.5 (UTF-8, Kreis-Validierung)
...
```
  ...
  dxf-writer: V1.5 (20260326-ac1009)
